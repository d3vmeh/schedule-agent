...
from .adk_tools import add_calendar_event, get_calendar_events, delete_calendar_event, list_calendars, get_time_info
...
root_agent = Agent(
    ...
    """,
    tools = [list_calendars, add_calendar_event, get_calendar_events, delete_calendar_event]
)
